...
- потом тестовый билд выкладывается командой `vercel --prod` в проект `amica-ru-test`
...
2. Готовый test-билд выкладывается командой `vercel --prod` в проект `amica-ru-test`.
